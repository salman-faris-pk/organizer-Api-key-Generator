 ...
 useEffect(() => {
  ...
  const fetchDashboardStats = async () => {
    try {
      ...
      if (axios.isAxiosError(error)) {
        toast.error(
          error.response?.data?.error ?? "Failed to load dashboard stats"
        );
      } else {
  ...
  return (
    <div className="space-y-6">
      {/* Welcome Section */}
      <div className="bg-slate-50 rounded-2xl p-6 shadow-md text-gray-900 border border-slate-200">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:block">
            <div className="bg-slate-200 rounded-full p-4 text-slate-700">
